...
`;
  ...
  return (
    <div className="h-screen bg-gray-950 text-gray-100 flex flex-col overflow-hidden">
      ...
      <footer className="border-t border-gray-800 bg-gray-950 py-2.5 px-4 flex flex-wrap items-center justify-center gap-2 flex-shrink-0">
        <span className="text-xs text-gray-600 mr-1">Tạo bởi</span>
        <a href="https://facebook.com/wolfmodkk" target="_blank" rel="noopener noreferrer"
          className="flex items-center gap-1.5 bg-blue-600/10 hover:bg-blue-600/20 border border-blue-600/25 text-blue-400 text-xs px-2.5 py-1 rounded-full transition-colors">
        ...
        <a href="https://youtube.com/@cheatmod796" target="_blank" rel="noopener noreferrer"
          className="flex items-center gap-1.5 bg-red-600/10 hover:bg-red-600/20 border border-red-600/25 text-red-400 text-xs px-2.5 py-1 rounded-full transition-colors">
        ...
        <a href="https://t.me/wolfmodyt" target="_blank" rel="noopener noreferrer"
          className="flex items-center gap-1.5 bg-sky-500/10 hover:bg-sky-500/20 border border-sky-500/25 text-sky-400 text-xs px-2.5 py-1 rounded-full transition-colors">
